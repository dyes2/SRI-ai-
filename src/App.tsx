    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 mt-16 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-4">
          <h1 className="text-3xl font-extrabold text-slate-900 mb-2">수원시정연구원 여정에 당신을 초대합니다.</h1>
          <p className="text-slate-500 max-w-2xl mb-8">수원시정연구원은 수원특례시 발전을 위하여 연구원 운영을 함께할 여러분의 지원을 기다립니다.</p>
          <Outlet />
        </div>
      </main>
